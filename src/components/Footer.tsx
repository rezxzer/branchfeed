...
export function Footer() {
  return (
    <footer className="border-t border-slate-800 bg-slate-950/80">
      <div className="mx-auto flex max-w-5xl items-center justify-between gap-3 px-4 py-4 text-xs text-slate-400 sm:text-sm">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <span className="text-slate-500">Built by Rezi</span>
